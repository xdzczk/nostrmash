...
| `WORKER_RETENTION_EVENT_TAGS_RUN_INTERVAL` | `worker` | optional | `5m0s` | How often the event_tags allowlist prune loop runs. Saturated batches catch up immediately between ticks. |
