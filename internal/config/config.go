...
// validateFilterGroups. Authored kinds (1, 4, 5, 9802, 10000, 10003, 30023)
// are author-trust-gated in internal/ingestor/live/gate.go; engagement kinds
// (6, 7, 9735) are target-gated; the rest (0, 3, 10002) stay open so the
